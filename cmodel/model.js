const {computeSegmentSegmentIntersection, IntersectionType} = require('../geomlib/compgeom')
const line = require('../geomlib/line');
const buildingModel = require('../IFC4/buildingModel');

module.exports = class model {
    constructor(){
        this.curves = [];
        this.building_model = new buildingModel();
        this.building_model.initIfcModel();
    }
